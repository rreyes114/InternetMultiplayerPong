...
#include <stdbool.h>
#include <stdint.h>
#include "G8RTOS.h"//"../G8RTOS_Lab5/G8RTOS.h"
...
#define ADD_THREAD_SLEEP_TIME 5

#define JOYSTICK_BIAS 100
...
/*********************************************** Public Functions *********************************************************************/
extern GameState_t gameState;  //received from host
extern GeneralPlayerInfo_t playerInfo; //send to host
...
extern threadId_t thread_IDs[MAX_THREADS];
extern uint8_t IDindex;
extern bool TPflag;
void startGame();
#endif /* GAME_H_ */
